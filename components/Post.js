...
const Post = ({ post, compact }) => {
  return (
    <div className="w-full px-10 py-6 bg-white rounded-lg shadow-md mt-6">
      {!compact && <Image src={post.frontmatter.cover_image} alt="cover pic" height={420} width={600} className="mb-4 rounded" />}
      ...
      {!compact && (
        <div className="flex justify-between items-center mt-6">
          ...
          <div className="flex items-center">
            <img src={post.frontmatter.author_image} alt="author pic" className="mx-4 w-10 h-10 object-cover rounded-full hidden sm:block" />
